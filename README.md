# All Restaurants in Greater Los Angeles Area (Metro), California, US
...
| Full dataset size | 35,170 records |
| Free sample size | 1,000 records (2.84%) |
| Last export | 2026-04-09T11:15:43.050994+00:00 |
| Download | [Latest release asset](https://github.com/Beamstation-Datasets/all-restaurants-in-greater-los-angeles-area-metro-california-us-sample-123920/releases/download/sample-latest/beamstation_123920_restaurants-us-losangeleslongbeachanaheimca_SAMPLE_DIST.csv) |
...
Search for dataset ID `123920` on BeamStation if you want the exact commercial listing.
